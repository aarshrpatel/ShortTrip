...
import storeImage from "@/assets/about/ST110.svg"; // Replace with your store image
import ceo from "@/assets/about/ceo.png"; // Replace with your team images
...
export default function About() {
  return (
    <div className="w-full">
      ...
      <div className="flex flex-col md:flex-row items-center justify-center gap-8 py-16 px-6 bg-gradient-to-r from-yellow to-red">
        {/* Story Text Section on the Left */}
      ...
      <div className="flex flex-col md:flex-row items-center justify-center gap-12 py-16 px-6 bg-gray-50 rounded-lg shadow-inner mx-4">
        {/* Founding Team Image */}
        <motion.div
          variants={fadeIn}
          initial="hidden"
      ...
      {/* Our Team Section without Shadow and Circular Borders */}
      <div className="py-16 px-6 bg-gray-100">
        <h2 className="text-4xl font-extrabold mb-8 text-gray-900 text-center">Our Team</h2>
      ...
      <div className="py-12 bg-red-100 text-center">
